      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        {clickMode ? (
          ...
          <div className="min-h-[400px] flex flex-col items-center justify-center">
            ...
            {/* Scene 3: Only Drink Me option */}
            {currentScene === 3 && (
              <div className="animate-fade-in w-full" onClick={nextScene}>
                <div className="flex flex-col md:flex-row items-center justify-center gap-8 my-12">
                  <div
                    className={`transition-all duration-1000 flex-shrink-0 ${aliceSize === "small" ? "animate-shrink" : ""
                      }`}
                    style={{
                      transform: aliceSize === "small" ? "scale(0.5)" : "scale(1)",
                    }}
                  >
                ...
                <div className="text-center mt-4 text-white/60 text-sm animate-pulse">
                  🧪 Try drinking, then click to continue
                </div>
              </div>
            )}
            ...
            {/* Scene 6: Alice responds "You again?" */}
            {currentScene === 6 && aliceSize === "small" && (
              <div className="animate-fade-in w-full" onClick={nextScene}>
                <DialogueBox
                  speaker="Alice"
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-8 my-12">
                  ...
                  <div className="flex justify-center">
                    {aliceSize === "small" ? (
                      ...
                      <div className="bg-black/55 backdrop-blur-md rounded-4xl p-8 border border-white/10 flex flex-col items-center opacity-75">
                        <img src={eatMeCake} alt="Eat me cake" className="w-20 h-20 mb-4 object-contain" />
                        <div className="font-serif text-2xl font-bold text-white">Eat Me</div>
                      </div>
                    )}
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 my-12">
              ...
              <div
                className={`transition-all duration-1000 flex-shrink-0 ${aliceSize === "small" ? "animate-shrink" : aliceSize === "large" ? "animate-grow" : ""
                  }`}
                style={{
